...
def process_sample_visualization(sample_data, file_name, visualizations_folder):
...
def analyze_all_files(data, data_files, visualizations_folder):
    ...
    for i, (key, item) in enumerate(data.items()):
        try:
            ...
            if i == 0:
                ...
                detailed_plot_path = os.path.join(visualizations_folder, detailed_plot_filename)
...
def main():
    ...
    results_folder, visualizations_folder = create_results_folder(data_folder)
    print(f"Results will be saved to: {results_folder}")
    print(f"Visualizations will be saved to: {visualizations_folder}")
    
    # Step 4: Show sample visualization for the first file
    if data_files:
        ...
        # Create and save sample visualization
        process_sample_visualization(sample_data, sample_file, visualizations_folder)
    
    # Step 5: Analyze all files
    print("\nAnalyzing all files...")
    results_df = analyze_all_files(data, data_files, visualizations_folder)
